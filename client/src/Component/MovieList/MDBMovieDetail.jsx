...
const MDBMovieDetail = () => {
  ...
  let videoSrc = movie.videoUrl;
  if (movie.videoUrl && movie.videoUrl.startsWith("/uploads")) {
    videoSrc = `http://localhost:5000${movie.videoUrl}`;
  }
  return (
    <div className="movie-detail-page">
      <div
        className="hero"
        style={{
          backgroundImage: `url(https://image.tmdb.org/t/p/original/5h2EsPKNDdB3MAtOk9MB9Ycg9Rz.jpg)`,
        }}
      >
